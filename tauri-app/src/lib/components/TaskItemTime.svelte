...
<Input
  ...
  disabled={isTracking}
  readonly={isTracking}
  class="font-mono text-xl transition-colors md:text-xl w-33 appearance-none border-none bg-transparent! disabled:opacity-100! disabled:cursor-default {!isTracking &&
    'cursor-text'}"
