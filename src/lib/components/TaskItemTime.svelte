...
<Input
  ...
  disabled={isTracking}
  readonly={isTracking}
  class="time-input-muted font-mono text-xl transition-colors md:text-xl w-33 appearance-none border-none bg-transparent! shadow-none disabled:opacity-100! disabled:cursor-default {!isTracking &&
    'cursor-text'}"
